let player,ship,shiplaser,playerlaser,cargoCollide,circleCollision,playerCollide,worldCollide,cargo,leaderboard,RedisManager;_202‍.x([["game",()=>game]]);_202‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_202‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_202‍.w("../shared/laser",[["shiplaser",["shiplaser"],function(v){shiplaser=v}],["playerlaser",["playerlaser"],function(v){playerlaser=v}]]);_202‍.w("./circlecol",[["cargoCollide",["cargoCollide"],function(v){cargoCollide=v}],["circleCollision",["circleCollision"],function(v){circleCollision=v}],["playerCollide",["playerCollide"],function(v){playerCollide=v}],["worldCollide",["worldCollide"],function(v){worldCollide=v}]]);_202‍.w("../shared/cargo",[["cargo",["cargo"],function(v){cargo=v}]]);_202‍.w("../shared/leaderboard",[["leaderboard",["leaderboard"],function(v){leaderboard=v}]]);_202‍.w("./redisManager",[["RedisManager",["RedisManager"],function(v){RedisManager=v}]]);
    ...
    constructor() {
        ...
        this.initializeGameState().catch(err => {
            _202‍.g.console.error('Failed to initialize game state:', err)
        })
    }
    ...
    async initializeGameState() {
        try {
            ...
            _202‍.g.console.error('Failed to initialize game state:', e)
        }
    }
    ...
    async addPlayer(user, socket) {
        try {
            ...
            if (!this.checkCollisions(temp)) {
                ...
                const newPlayer = new player(user, ship_id, 1, 2, null)
            ...
            _202‍.g.console.error('Failed to add player:', e)
    ...
    async syncGameState() {
        try {
            ...
            _202‍.g.console.error('Failed to sync game state:', err)
        }
    }
}   