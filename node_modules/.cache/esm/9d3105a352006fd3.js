let player,ship,shiplaser,playerlaser,circleCollision,playerCollide,worldCollide;_520‍.x([["game",()=>game]]);_520‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_520‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_520‍.w("../shared/laser",[["shiplaser",["shiplaser"],function(v){shiplaser=v}],["playerlaser",["playerlaser"],function(v){playerlaser=v}]]);_520‍.w("./circlecol",[["circleCollision",["circleCollision"],function(v){circleCollision=v}],["playerCollide",["playerCollide"],function(v){playerCollide=v}],["worldCollide",["worldCollide"],function(v){worldCollide=v}]]);
