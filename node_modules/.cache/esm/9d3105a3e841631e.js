let player,ship,laser,checkCollisions;_e84‍.x([["game",()=>game]]);_e84‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_e84‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_e84‍.w("../shared/laser",[["laser",["laser"],function(v){laser=v}]]);_e84‍.w("./collisions",[["checkCollisions",["checkCollisions"],function(v){checkCollisions=v}]]);
    ...
    handleFire(rotation, ship) {
        ...
        const rot = rotation + parentShip.rotation - Math.PI
