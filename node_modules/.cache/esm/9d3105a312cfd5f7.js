let player,ship,laser;_12c‍.x([["game",()=>game]]);_12c‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_12c‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_12c‍.w("../shared/laser",[["laser",["laser"],function(v){laser=v}]]);
    ...
    handleFire(rotation, ship) {
        ...
        const originx = 0
        const originy = 10 * parentShip.shipblock
        ...
        this.shiplasers.push(new laser(x, y, rot, ship))
    }
