let ship;_125‍.x([["player",()=>player]]);_125‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);
       class player {
    ...
    update() {
        if (this.keys.left) {
            this.movePlayer(this.worldPosition.x - 5, this.worldPosition.y)
            if (this.direction === 1) {
            ...
            this.movePlayer(p.worldPosition.x + 5, p.worldPosition.y)
            if (this.direction === 3) {
                this.animation = this.animation < 8 ? this.animation + 1 : 0
            }
            else {
            ...
            this.movePlayer(p.worldPosition.x, p.worldPosition.y - 5)
            ...
            this.movePlayer(this.worldPosition.x, this.worldPosition.y + 5)
            if (this.direction === 2) {
                this.animation = this.animation < 8 ? this.animation + 1 : 0
            }
            else {
