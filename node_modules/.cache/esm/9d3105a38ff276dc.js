let player,ship,shiplaser,playerlaser,cargoCollide,circleCollision,playerCollide,worldCollide,cargo,leaderboard;_8ff‍.x([["game",()=>game]]);_8ff‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_8ff‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_8ff‍.w("../shared/laser",[["shiplaser",["shiplaser"],function(v){shiplaser=v}],["playerlaser",["playerlaser"],function(v){playerlaser=v}]]);_8ff‍.w("./circlecol",[["cargoCollide",["cargoCollide"],function(v){cargoCollide=v}],["circleCollision",["circleCollision"],function(v){circleCollision=v}],["playerCollide",["playerCollide"],function(v){playerCollide=v}],["worldCollide",["worldCollide"],function(v){worldCollide=v}]]);_8ff‍.w("../shared/cargo",[["cargo",["cargo"],function(v){cargo=v}]]);_8ff‍.w("../shared/leaderboard",[["leaderboard",["leaderboard"],function(v){leaderboard=v}]]);
