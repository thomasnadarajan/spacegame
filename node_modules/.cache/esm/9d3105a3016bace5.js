let player,ship,laser,circleCollision;_016‍.x([["game",()=>game]]);_016‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_016‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_016‍.w("../shared/laser",[["laser",["laser"],function(v){laser=v}]]);_016‍.w("./circlecol",[["circleCollision",["circleCollision"],function(v){circleCollision=v}]]);
    ...
    addPlayer(socket, player_user, pair = null) {
        if(pair === null) {
            ...
            _016‍.g.console.log(ship_id2, ": ", this.ships[ship_id2].position.x - (5 * this.ships[ship_id2].shipblock))
        }
        else {
            for (let i = 0; i < 10; i++) {
                for (let j = 0; j < 10; j++) {
