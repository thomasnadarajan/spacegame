...
eval(_7cf‍.c("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"ship_map\": () => (/* binding */ ship_map),\n/* harmony export */   \"ship_mats\": () => (/* binding */ ship_mats)\n/* harmony export */ });\n/* harmony import */ var _assets_tilemap_editor_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assets/tilemap-editor.json */ \"./src/client/assets/tilemap-editor.json\");\n\n//import ship_json from './assets/oldtilemap-editor.json'\n/*\n// load json\nfunction loadJSON(filename) {\n    let file = require(filename)\n    const str = JSON.stringify(file)\n    return JSON.parse(str)\n}\n*/\n// load images\nfunction loadImage(filename) {\n    const img = new Image()\n    img.src = filename\n    return img\n}\n\nconst ship_map = _assets_tilemap_editor_json__WEBPACK_IMPORTED_MODULE_0__\n\nconst ship_mats = loadImage('./assets/scifitiles-sheet.png')\n\n//# sourceURL=webpack://spacegame/./src/client/asset.js?"));
...
eval(_7cf‍.c("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./render */ \"./src/client/render.js\");\n/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! socket.io-client */ \"./node_modules/socket.io-client/build/esm/index.js\");\n\n\nconst socket = (0,socket_io_client__WEBPACK_IMPORTED_MODULE_1__.io)(\"http://localhost:3000\")\nsocket.on('connect', () => {\n    console.log(socket.id)\n})\n;(0,_render__WEBPACK_IMPORTED_MODULE_0__.setCanvasDims)()\n;(0,_render__WEBPACK_IMPORTED_MODULE_0__.animate)()\n\n\n\n//# sourceURL=webpack://spacegame/./src/client/index.js?"));
...
eval(_7cf‍.c("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"animate\": () => (/* binding */ animate),\n/* harmony export */   \"setCanvasDims\": () => (/* binding */ setCanvasDims)\n/* harmony export */ });\n/* harmony import */ var _asset__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./asset */ \"./src/client/asset.js\");\n/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./player */ \"./src/client/player.js\");\n/* harmony import */ var _ship__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ship */ \"./src/client/ship.js\");\n/* harmony import */ var _menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./menu */ \"./src/client/menu.js\");\n\n\n\n\n\nCanvasRenderingContext2D.prototype.roundRect = function (x, y, w, h, r) {\n    if (w < 2 * r) r = w / 2;\n    if (h < 2 * r) r = h / 2;\n    this.beginPath();\n    this.moveTo(x+r, y);\n    this.arcTo(x+w, y,   x+w, y+h, r);\n    this.arcTo(x+w, y+h, x,   y+h, r);\n    this.arcTo(x,   y+h, x,   y,   r);\n    this.arcTo(x,   y,   x+w, y,   r);\n    this.closePath();\n    return this;\n  }\n\nconst canvas = document.querySelector('canvas')\n\n// perhaps move the menu stack to the client side game app\nlet menustack = []\nconst c = canvas.getContext('2d')\n\nfunction setCanvasDims() {\n    const scaleRatio = Math.max(1,400/innerWidth)\n    canvas.width = scaleRatio * innerWidth\n    canvas.height = scaleRatio * innerHeight\n    c.width = scaleRatio * innerWidth\n    c.height = scaleRatio * innerHeight\n    //c.fillStyle = 'solid black'\n    //c.fillRect(0, 0, canvas.width, canvas.height)\n}\n\n\n/*\nALL THIS STUFF IS CLIENT-SIDE STUFF \n*/\n\n\n\n\n\nconst s = new _ship__WEBPACK_IMPORTED_MODULE_2__.ship(100, 100, true)\nconst test = new _ship__WEBPACK_IMPORTED_MODULE_2__.ship(200, 400, false)\nconst test2 = new _ship__WEBPACK_IMPORTED_MODULE_2__.ship(-200, 400, false)\nconst testMenu = new _menu__WEBPACK_IMPORTED_MODULE_3__.cargomenu()\n\n// this is just temp stuff, will eventually allocate raandom TP pad to spawn\n\nconst p = new _player__WEBPACK_IMPORTED_MODULE_1__.player(s, 1, 2)\nvar player_mode = false\n// will eventually add to the index page for client\n\naddEventListener('mousemove', (e) => {\n    if (player_mode === false) {\n        const newdir = Math.atan2(e.x - window.innerWidth / 2, window.innerHeight / 2 - e.y)\n        s.setRotation(newdir)\n    }\n})\naddEventListener('keydown', ({key}) => {\n    if (player_mode) {\n        switch (key) {\n            case 'w':\n                p.setPressed('up')\n                break\n            case 's':\n                p.setPressed('down')\n                break\n            case 'd':\n                p.setPressed('right')\n                break\n            case 'a':\n                p.setPressed('left')\n                break\n            case 'q':\n                player_mode = false\n                break\n        }\n    }\n    else {\n        switch (key) {\n            case 'q':\n                player_mode = true\n                break\n            case 'w':\n                s.moving = true\n                break\n        }\n    }\n})\naddEventListener('keyup', ({key}) => {\n    if (player_mode) {\n        switch (key) {\n            case 'w':\n                p.setUnpressed('up')\n                break\n            case 's':\n                p.setUnpressed('down')\n                break\n            case 'd':\n                p.setUnpressed('right')\n                break\n            case 'a':\n                p.setUnpressed('left')\n                break\n        }\n    }\n    else {\n        switch (key) {\n            case 'w':\n                s.moving = false\n                break\n        }\n    }\n})\naddEventListener('resize', () => {\n    console.log('gets here: resize')\n    setCanvasDims()\n})\n\naddEventListener('mouseover', (e) => {\n\n})\n\nfunction playerRenderPilotMode(player, currentShip) {\n\n    // this will eventually be replaced by the parent ship\n    const canvasX = canvas.width / 2 + (s.position.x - currentShip.position.x)\n    const canvasY = canvas.height / 2 + (s.position.y - currentShip.position.y)\n    c.save()\n    c.translate(canvasX, canvasY)\n    c.rotate(s.rotation)\n    c.fillStyle = 'red'\n    c.fillRect(-player.width / 2 + (player.position.x * s.shipblock) - (5 * s.shipblock) + s.shipblock / 2, -player.height / 2 + (player.position.y * s.shipblock) - (5 * s.shipblock) + s.shipblock / 2, \n    player.width, player.height)\n    c.restore()\n}\nfunction renderTransportSendMenu(menu) {\n    \n}\nfunction renderMenuHeader(menu) {\n    c.fillStyle = '#cc2233'\n    c.roundRect(menu.topBoundHoriz, menu.topBoundVert, menu.width, menu.headerHeight, 15).fill()\n    c.font = menu.headerFontSize.concat(\"px Antonio\")\n    c.fillStyle = 'black'\n    c.textAlign = 'left'\n    c.fillText(menu.heading, menu.topBoundHoriz * 1.1, menu.topBoundVert + 0.8 * menu.headerHeight)\n}\nfunction renderCargoMenu(menu) {\n    // HEADER STUFF\n    renderMenuHeader(menu)\n    // MAIN STUFF\n    c.fillStyle = '#ffaa90'\n    c.fillRect(testMenu.topBoundHoriz, testMenu.mainTopBound,testMenu.width, testMenu.mainHeight)\n    c.fillStyle = 'black'\n    c.font = testMenu.mainFontSize.concat(\"px Antonio\")\n    for (const comp in testMenu.components) {\n        if (testMenu.components[comp].Type === 'button') {\n            c.textAlign = 'center'\n            c.font = testMenu.buttonFontSize.concat(\"px Antonio\")\n            c.fillText(comp, testMenu.components[comp].LeftBound, testMenu.components[comp].BotBound)\n        }\n        else {\n            c.textAlign = 'left'\n            c.font = testMenu.mainFontSize.concat(\"px Antonio\")\n            c.fillText(testMenu.units.toString().concat(\" \").concat(comp), testMenu.components[comp].LeftBound, testMenu.components[comp].BotBound)\n        }\n    }\n\n}\n\nfunction playerRenderPlayerMode(player, currentShip) {\n    // any reference to s will be replaced by reference to the ship the player being rendered is on\n    // currentShip refers to the ship that is at present in the center of THIS player's screen\n    const canvasX = canvas.width / 2 + (s.position.x - currentShip.position.x)\n    const canvasY = canvas.height / 2 + (s.position.y - currentShip.position.y)\n    c.save()\n    if (s.position.x - currentShip.position.x !== 0 || s.position.y - currentShip.position.y !== 0) {\n        c.translate(canvas.width/2, canvas.height/2)\n        c.rotate(-1 * currentShip.rotation)\n        c.translate(-canvas.width/2, -canvas.height/2)\n    }\n    c.translate(canvasX, canvasY)\n    if (s.position.x - currentShip.position.x !== 0 || s.position.y - currentShip.position.y !== 0) {\n        c.rotate(_ship__WEBPACK_IMPORTED_MODULE_2__.ship.rotation)\n    }\n    c.fillStyle = 'red'\n    c.fillRect(-player.width / 2 + (player.position.x * currentShip.shipblock) - (5 * currentShip.shipblock) + currentShip.shipblock / 2, -player.height / 2 + (player.position.y * currentShip.shipblock) - (5 * currentShip.shipblock) + currentShip.shipblock / 2, \n    player.width, player.height)\n    c.restore()\n}\n// simple function that takes in a ship, and renders using the blocks based on the ship position\nfunction shipDraw(ship) {\n    const left_most_x = -1 * (5 * ship.shipblock)\n    const left_most_y = -1 * (5 * ship.shipblock)\n    for (const key_map of Object.keys(_asset__WEBPACK_IMPORTED_MODULE_0__.ship_map.map)) {\n        const sp = key_map.split(\"-\")\n        const symb  = _asset__WEBPACK_IMPORTED_MODULE_0__.ship_map.map[key_map].tileSymbol\n        const start_x = left_most_x + (parseInt(sp[0]) * ship.shipblock)\n        const start_y = left_most_y+ (parseInt(sp[1]) * ship.shipblock)\n        for (const key_tile in _asset__WEBPACK_IMPORTED_MODULE_0__.ship_map.tileSet) {\n            const tile = _asset__WEBPACK_IMPORTED_MODULE_0__.ship_map.tileSet[key_tile]\n            if (tile.tileSymbol === symb) {\n                c.drawImage(_asset__WEBPACK_IMPORTED_MODULE_0__.ship_mats, tile.x * 32, tile.y * 32, 32, 32, start_x, start_y, ship.shipblock, ship.shipblock)\n            }\n        }\n    }\n}\n// this function renders ships in player view\n// currentShip is a reference to whichever ship the player is currently on\nfunction shipRenderPlayerMode(ship, currentShip) {\n    const canvasX = canvas.width / 2 + (ship.position.x - currentShip.position.x)\n    const canvasY = canvas.height / 2 + (ship.position.y - currentShip.position.y)\n    c.save()\n    if (ship.position.x - currentShip.position.x !== 0 || ship.position.y - currentShip.position.y !== 0) {\n        c.translate(canvas.width/2, canvas.height/2)\n        c.rotate(-1 * currentShip.rotation)\n        c.translate(-canvas.width/2, -canvas.height/2)\n    }\n    c.translate(canvasX, canvasY)\n    if (ship.position.x - currentShip.position.x !== 0 || ship.position.y - currentShip.position.y !== 0) {\n        c.rotate(ship.rotation)\n    }\n    shipDraw(ship)\n    c.restore()\n}\n\n// this is the rendering setup for pilot mode\n\nfunction shipRenderPilotMode(ship, currentShip) {\n    const canvasX = canvas.width / 2 + (ship.position.x - currentShip.position.x)\n    const canvasY = canvas.height / 2 + (ship.position.y - currentShip.position.y)\n    c.save()\n    c.translate(canvasX, canvasY)\n    c.rotate(ship.rotation)\n    shipDraw(ship)\n    c.restore()\n}\n// player always renders in the center of the screen\n// many test functions in here at the moment\nfunction animate() {\n    requestAnimationFrame(animate)\n    c.clearRect(0, 0, canvas.width, canvas.height);\n    s.update()\n    p.update()\n    if (!player_mode) {\n        shipRenderPilotMode(s, s)\n        playerRenderPilotMode(p, s)\n        shipRenderPilotMode(test, s)\n        shipRenderPilotMode(test2, s) \n    }\n    else {\n        shipRenderPlayerMode(s, s)\n        playerRenderPlayerMode(p, s)\n        shipRenderPlayerMode(test, s)\n        shipRenderPlayerMode(test2, s) \n    }\n    testMenu.update(s)\n    //renderMenu()\n}\n\n//# sourceURL=webpack://spacegame/./src/client/render.js?"));
...
eval(_7cf‍.c("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"hasCORS\": () => (/* binding */ hasCORS)\n/* harmony export */ });\n// imported from https://github.com/component/has-cors\nlet value = false;\ntry {\n    value = typeof XMLHttpRequest !== 'undefined' &&\n        'withCredentials' in new XMLHttpRequest();\n}\ncatch (err) {\n    // if XMLHttp support is disabled in IE then it will throw\n    // when trying to create\n}\nconst hasCORS = value;\n\n\n//# sourceURL=webpack://spacegame/./node_modules/engine.io-client/build/esm/contrib/has-cors.js?"));
...
eval(_7cf‍.c("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"decode\": () => (/* binding */ decode),\n/* harmony export */   \"encode\": () => (/* binding */ encode)\n/* harmony export */ });\n// imported from https://github.com/galkn/querystring\n/**\n * Compiles a querystring\n * Returns string representation of the object\n *\n * @param {Object}\n * @api private\n */\nfunction encode(obj) {\n    let str = '';\n    for (let i in obj) {\n        if (obj.hasOwnProperty(i)) {\n            if (str.length)\n                str += '&';\n            str += encodeURIComponent(i) + '=' + encodeURIComponent(obj[i]);\n        }\n    }\n    return str;\n}\n/**\n * Parses a simple querystring into an object\n *\n * @param {String} qs\n * @api private\n */\nfunction decode(qs) {\n    let qry = {};\n    let pairs = qs.split('&');\n    for (let i = 0, l = pairs.length; i < l; i++) {\n        let pair = pairs[i].split('=');\n        qry[decodeURIComponent(pair[0])] = decodeURIComponent(pair[1]);\n    }\n    return qry;\n}\n\n\n//# sourceURL=webpack://spacegame/./node_modules/engine.io-client/build/esm/contrib/parseqs.js?"));
...
eval(_7cf‍.c("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"globalThisShim\": () => (/* binding */ globalThisShim)\n/* harmony export */ });\nconst globalThisShim = (() => {\n    if (typeof self !== \"undefined\") {\n        return self;\n    }\n    else if (typeof window !== \"undefined\") {\n        return window;\n    }\n    else {\n        return Function(\"return this\")();\n    }\n})();\n\n\n//# sourceURL=webpack://spacegame/./node_modules/engine.io-client/build/esm/globalThis.browser.js?"));
...
eval(_7cf‍.c("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"on\": () => (/* binding */ on)\n/* harmony export */ });\nfunction on(obj, ev, fn) {\n    obj.on(ev, fn);\n    return function subDestroy() {\n        obj.off(ev, fn);\n    };\n}\n\n\n//# sourceURL=webpack://spacegame/./node_modules/socket.io-client/build/esm/on.js?"));
