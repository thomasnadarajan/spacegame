let player,ship,shiplaser,playerlaser,cargoCollide,circleCollision,playerCollide,worldCollide,cargo,leaderboard;_12a‍.x([["game",()=>game]]);_12a‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_12a‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_12a‍.w("../shared/laser",[["shiplaser",["shiplaser"],function(v){shiplaser=v}],["playerlaser",["playerlaser"],function(v){playerlaser=v}]]);_12a‍.w("./circlecol",[["cargoCollide",["cargoCollide"],function(v){cargoCollide=v}],["circleCollision",["circleCollision"],function(v){circleCollision=v}],["playerCollide",["playerCollide"],function(v){playerCollide=v}],["worldCollide",["worldCollide"],function(v){worldCollide=v}]]);_12a‍.w("../shared/cargo",[["cargo",["cargo"],function(v){cargo=v}]]);_12a‍.w("../shared/leaderboard",[["leaderboard",["leaderboard"],function(v){leaderboard=v}]]);
    ...
    addTimeout(socket) {
        this.timeouts[socket] = setTimeout(() => {
            ...
            this.disconnect(this.sockets[socket])
        }, 5000)
    }
