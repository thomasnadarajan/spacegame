let player,ship,laser,checkCollisions;_7ca‍.x([["game",()=>game]]);_7ca‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_7ca‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_7ca‍.w("../shared/laser",[["laser",["laser"],function(v){laser=v}]]);_7ca‍.w("./collisions",[["checkCollisions",["checkCollisions"],function(v){checkCollisions=v}]]);
    ...
    addPlayer(socket, player_user, pair = null) {
        if(pair === null) {
            ...
            _7ca‍.g.console.log(ship_id2, ": ", this.ships[ship_id2].position.x - (5 * this.ships[ship_id2].shipblock))
        }
        else {
            for (let i = 0; i < 10; i++) {
                for (let j = 0; j < 10; j++) {
    ...
    handleFire(rotation, ship) {
        ...
        _7ca‍.g.console.log(parentShip.id, "x: ", parentShip.position.x - 5 * parentShip.shipblock, " y: ", parentShip.position.y - 5 * parentShip.shipblock)
