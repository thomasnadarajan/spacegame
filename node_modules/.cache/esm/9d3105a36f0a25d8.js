let player,ship,shiplaser,playerlaser,circleCollision,playerCollide,worldCollide;_6f0‍.x([["game",()=>game]]);_6f0‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_6f0‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_6f0‍.w("../shared/laser",[["shiplaser",["shiplaser"],function(v){shiplaser=v}],["playerlaser",["playerlaser"],function(v){playerlaser=v}]]);_6f0‍.w("./circlecol",[["circleCollision",["circleCollision"],function(v){circleCollision=v}],["playerCollide",["playerCollide"],function(v){playerCollide=v}],["worldCollide",["worldCollide"],function(v){worldCollide=v}]]);
