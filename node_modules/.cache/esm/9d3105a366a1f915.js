let player,ship,shiplaser,playerlaser,circleCollision,playerCollide,worldCollide;_66a‍.x([["game",()=>game]]);_66a‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_66a‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_66a‍.w("../shared/laser",[["shiplaser",["shiplaser"],function(v){shiplaser=v}],["playerlaser",["playerlaser"],function(v){playerlaser=v}]]);_66a‍.w("./circlecol",[["circleCollision",["circleCollision"],function(v){circleCollision=v}],["playerCollide",["playerCollide"],function(v){playerCollide=v}],["worldCollide",["worldCollide"],function(v){worldCollide=v}]]);
        ...
        if (this.shouldSendUpdate) {
            ...
            for (const player in this.players) {
                if (this.players[player].health === 0) {
                    ...
                    this.players[player].health = Math.max(this.players[player].health + 1, this.players[player].health)
                }
            }
