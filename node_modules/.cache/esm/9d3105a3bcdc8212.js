let player,ship,shiplaser,playerlaser,circleCollision,playerCollide,worldCollide;_bcd‍.x([["game",()=>game]]);_bcd‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_bcd‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_bcd‍.w("../shared/laser",[["shiplaser",["shiplaser"],function(v){shiplaser=v}],["playerlaser",["playerlaser"],function(v){playerlaser=v}]]);_bcd‍.w("./circlecol",[["circleCollision",["circleCollision"],function(v){circleCollision=v}],["playerCollide",["playerCollide"],function(v){playerCollide=v}],["worldCollide",["worldCollide"],function(v){worldCollide=v}]]);
