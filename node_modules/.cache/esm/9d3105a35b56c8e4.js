let player,ship,laser,checkCollisions,circleCollision;_5b5‍.x([["game",()=>game]]);_5b5‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_5b5‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_5b5‍.w("../shared/laser",[["laser",["laser"],function(v){laser=v}]]);_5b5‍.w("./collisions",[["checkCollisions",["checkCollisions"],function(v){checkCollisions=v}]]);_5b5‍.w("./circlecol",[["circleCollision",["circleCollision"],function(v){circleCollision=v}]]);
    ...
    addPlayer(socket, player_user, pair = null) {
        if(pair === null) {
            ...
            _5b5‍.g.console.log(ship_id2, ": ", this.ships[ship_id2].position.x - (5 * this.ships[ship_id2].shipblock))
        }
        else {
            for (let i = 0; i < 10; i++) {
                for (let j = 0; j < 10; j++) {
    ...
    update(){
        if (this.shouldSendUpdate) {
            ...
            this.shiplasers = this.shiplasers.filter()
    ...
    /*
    will determine if necessary to use this later
    updateLasers() {
        for (const laser of this.shiplasers) {
