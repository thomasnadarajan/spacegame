let player,ship,shiplaser,playerlaser,circleCollision,playerCollide,worldCollide;_f6d‍.x([["game",()=>game]]);_f6d‍.w("../shared/player",[["player",["player"],function(v){player=v}]]);_f6d‍.w("../shared/ship",[["ship",["ship"],function(v){ship=v}]]);_f6d‍.w("../shared/laser",[["shiplaser",["shiplaser"],function(v){shiplaser=v}],["playerlaser",["playerlaser"],function(v){playerlaser=v}]]);_f6d‍.w("./circlecol",[["circleCollision",["circleCollision"],function(v){circleCollision=v}],["playerCollide",["playerCollide"],function(v){playerCollide=v}],["worldCollide",["worldCollide"],function(v){worldCollide=v}]]);
